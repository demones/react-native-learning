# ScrollView 组件 - 滚动视图
该组件类似 web 页面中设置了 overflow 为 auto 或 scroll 的元素。作为容器来展现子元素，
当子元素超过 ScrollView 时显示滚动条。
...
<View style={styles.container}>
  {
    ScrollViewExample.map((item, index) => {
      return (
...
http://reactnative.cn/docs/scrollview.html#content
